...
class StreamingHandler(server.BaseHTTPRequestHandler):
    def do_GET(self):
        if self.path == '/':
            ...
            content: bytes = PAGE.encode('utf-8')
...
streamFfmpeg = FfmpegOutput(streamOutput)

fileOutput = FfmpegOutput("video.mp4")

encoder = MJPEGEncoder()

encoder.output = [FileOutput(streamOutput), fileOutput]
